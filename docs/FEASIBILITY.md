# Tony Hawk's Pro Skater 2 feasibility binding

## Identity

- Title and region: Tony Hawk's Pro Skater 2, USA.
- Serial: SLUS-01066.
- Source executable path: `disc/SLUS_010.66`.
- Load address: `0x80010000`.
- Entry point: `0x800A2910`.
- Source disc binding: `disc/Tony Hawk's Pro Skater 2 (USA).cue`.
...
The clean source commit is `724d770bd3e6457fb3cd2ef2f0860ff0c33a370d`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 1886 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `724d770bd3e6457fb3cd2ef2f0860ff0c33a370d`.
- Portfolio `tony-hawk-s-pro-skater-2/BUILDINFO.json`.
- Portfolio `tony-hawk-s-pro-skater-2/RECEIPT.md`.
